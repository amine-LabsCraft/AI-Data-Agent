...
class ETLTools:
    ...
    def execute_code(self, code: str):
        ...
        Returns:
            str: The output of the executed code (captured stdout, if any) or an
            error message if execution fails.
        """
        local_vars = {}
        output_buffer = io.StringIO()
        try:
            # globals() donne accès à pd/os déjà importés dans ce module,
            # local_vars isole les variables créées par le code exécuté.
            ...
            return f"Failed to execute code: {type(e).__name__}: {e}"
